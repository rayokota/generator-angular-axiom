...
EntityGenerator.prototype.files = function files() {
  ...
  this.template('../../app/templates/priv/_app.config', privDir + 'app.config');
  this.template('../../app/templates/src/_app_sup.erl', srcDir + this.baseName + '_sup.erl');
  this.template('../../app/templates/src/_app_routes.erl', srcDir + this.baseName + '_routes.erl');
  this.template('src/_app_entities.erl', srcDir + this.baseName + '_' + pluralize(this.name) + '.erl');
